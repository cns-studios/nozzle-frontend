      ...
      <section className="content-section">
        ...
        <div className="command-bar">
          <span className="command-text">
            @nozzle implement the logo images/logo.png across the entire
            service....
          </span>
          <svg
